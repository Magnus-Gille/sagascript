...
`ggerganov/whisper.cpp` at `5359861c739e955e79d9a303bcbc70fb988958b1` for the generic
...
duration against its source WAV's exact 16 kHz sample count. The recorded SHA-256
of the audit report file `sagascript-r4-pl-duration-audit.json` is
`2446ef013748a063ed30e82ac6ae6f6c65a711a21402efc4090e8a5c51bcc2a3`.
The same corpus, thresholds, and model outputs were retained; v2 validated **all
144 pairs**.
...
separate absolute 1,500 ms gate. Generic Small also exceeded that absolute budget
on this host; its lower WER is not a reason to promote it to a new default.
